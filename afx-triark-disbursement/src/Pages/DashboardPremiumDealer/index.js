...
import { getLock, releaseLock } from '../../Redux/Services/dashboard';
import './index.scss';
import { SearchOutlined, LoadingOutlined } from '@ant-design/icons';
import { getPremiumCaseListing } from '../../Redux/Services/PremiumDealer';
...
function index(props) {
  ...
  useEffect(() => {
    setHeading('Premium Dealer Listing Dashboard');
  ...
  useEffect(() => {
    ...
    const getData = async () => {
      ...
      if (!mainCondition) {
        const caseList = await getPremiumCaseListing({
          ...filter.caseList,
          ...filter.caseCount,
        });
        //
