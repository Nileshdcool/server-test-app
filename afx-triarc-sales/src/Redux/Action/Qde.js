import {
  ...
  DELETE_UPLOADED_SELFIE_FB,
  DELETE_UPLOADED_SELFIE_FB_SUCCESS,
  DELETE_UPLOADED_SELFIE_FB_FAILURE,
  GET_MAX_AMT,
  GET_MAX_AMT_SUCCESS,
  GET_MAX_AMT_FAILURE,
  RESET_QDE_SCHEMES_SUCCESS,
  SAVE_PAN_GET_GST_SUCCESS,
  SAVE_PAN_GET_GST_FAILURE,
  GET_GST_ADDRESS_SUCCESS,
  GET_GST_ADDRESS_FAILURE,
  GET_SCHEME_CODE_SUCCESS,
  GET_SCHEME_CODE_FAILURE,
  GET_SCHEME_DETAILS_SUCCESS,
  GET_SCHEME_DETAILS_FAILURE,
  PENNY_DROP_SUCCESS,
  PENNY_DROP_FAILURE,
  UPLOAD_DOC_FB_SUCCESS,
  UPLOAD_DOC_FB_FAILURE,
  UPLOAD_SELFIE_FB_SUCCESS,
  UPLOAD_SELFIE_FB_FAILURE,
...
export const uploadDocumentSuccessFB = (obj) => {
  return { type: UPLOAD_DOC_FB_SUCCESS, payload: obj };
};

export const uploadDocumentFailureFB = (obj) => {
  return { type: UPLOAD_DOC_FB_FAILURE, payload: obj };
};
...
export const uploadSelfieSuccessFB = (obj) => {
  return { type: UPLOAD_SELFIE_FB_SUCCESS, payload: obj };
};

export const uploadSelfieFailureFB = (obj) => {
  return { type: UPLOAD_SELFIE_FB_FAILURE, payload: {} };
};
...
export const deleteUploadedSelfieFB = (obj) => {
  return { type: DELETE_UPLOADED_SELFIE_FB, payload: {} };
};

export const deleteUploadedSelfieSuccessFB = (obj) => {
  return { type: DELETE_UPLOADED_SELFIE_FB_SUCCESS, payload: obj };
};

export const deleteUploadedSelfieFailureFB = (obj) => {
  return { type: DELETE_UPLOADED_SELFIE_FB_FAILURE, payload: {} };
};
...
export const savePanGetGstSuccess = (obj) => {
  return { type: SAVE_PAN_GET_GST_SUCCESS, payload: obj };
};

export const savePanGetGstFailure = (obj) => {
  return { type: SAVE_PAN_GET_GST_FAILURE, payload: obj };
};

export const getGstAddressSuccess = (obj) => {
  return { type: GET_GST_ADDRESS_SUCCESS, payload: obj };
};

export const getGstAddressFailure = (obj) => {
  return { type: GET_GST_ADDRESS_FAILURE, payload: obj };
};

export const schemeCodeSuccess = (obj) => {
  return { type: GET_SCHEME_CODE_SUCCESS, payload: obj };
};

export const schemeCodeFailure = (obj) => {
  return { type: GET_SCHEME_CODE_FAILURE, payload: obj };
};

export const schemeCodeDetailsSuccess = (obj) => {
  return { type: GET_SCHEME_DETAILS_SUCCESS, payload: obj };
};

export const schemeCodeDetailsFailure = (obj) => {
  return { type: GET_SCHEME_DETAILS_FAILURE, payload: obj };
};

export const getPennyDropSuccess = (obj) => {
  return { type: PENNY_DROP_SUCCESS, payload: obj };
};

export const getPennyDropFailure = (obj) => {
  return { type: PENNY_DROP_FAILURE, payload: obj };
};
