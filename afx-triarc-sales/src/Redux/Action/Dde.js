import {
  ...
  RESET_DDE,
  GET_FINBIT_URL_SUCCESS,
  GET_FINBIT_URL_FAILURE,
} from "../Constants";
...
export const getFinbitUrlSuccess = (obj) => {
  return { type: GET_FINBIT_URL_SUCCESS, payload: obj };
};

export const getFinbitUrlFailure = (obj) => {
  return { type: GET_FINBIT_URL_FAILURE, payload: obj };
};