...
function qdeReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case UPLOAD_DOC_FB_FAILURE:
      return {
        ...state,
        uploadedDocumentDataFB: { success: {}, error: action.payload },
      };
    case UPLOAD_DOC_FB_SUCCESS:
      return {
        ...state,
        uploadedDocumentDataFB: { success: action.payload, error: {} },
      };
    ...
    case UPLOAD_SELFIE_FB_SUCCESS:
      return { ...state, uploadSelfieFB: action.payload, loading: false };

    case UPLOAD_SELFIE_FB_FAILURE:
      return { ...state, uploadSelfieFB: [], loading: false };
    ...
    //
    case DELETE_UPLOADED_SELFIE_FB_SUCCESS:
      return {
        ...state,
        deleteUploadedSelfieFB: action.payload,
        loading: false,
        isSelfieDeletedFB: true,
        uploadSelfieFB: null,
      };

    case DELETE_UPLOADED_SELFIE_FB_FAILURE:
      return {
        ...state,
        deleteUploadedSelfieFB: [],
        loading: false,
        isSelfieDeletedFB: false,
      };
    ...
    case SAVE_PAN_GET_GST_SUCCESS:
      return {
        ...state,
        addSuccess: true,
        panGstDetails: action.payload,
        savePanGst: true,
        // getQdeDetails: true,
      };

    case SAVE_PAN_GET_GST_FAILURE:
      return {
        ...state,
        panGstDetails: {},
        savePanGst: false,
    ...
    case GET_GST_ADDRESS_SUCCESS:
      return {
        ...state,
        addSuccess: true,
        GstAddressDetails: action.payload,
        saveGstAddress: true,
        // getQdeDetails: true,
      };

    case GET_GST_ADDRESS_FAILURE:
      return {
        ...state,
        GstAddressDetails: {},
        saveGstAddress: false,
        // getQdeDetails: false,
      };
    ...
    case PENNY_DROP_SUCCESS:
      return {
        ...state,
        pennyDropDetails: action.payload,
        pennySuccess: true,
      };
    case PENNY_DROP_FAILURE:
      return {
        ...state,
        pennyDropDetails: {},
        pennySuccess: false,
