...
export const postAddDirectLeads =
  ...
  async (dispatch) => {
    ...
    try {
      const response = await post("/triarc-sales/lead/addLead", objBody, false);
...
export const createConcent =
  ...
  async (dispatch) => {
    dispatch(loading(true));
    try {
      const response = await post(`/triarc-sales/lead/createConsent`, objBody);
      ts(response.data.message);
...
export const verifyConsent =
  ...
  async (dispatch) => {
    ...
    try {
      const response = await post(`/triarc-sales/lead/verifyConsent`, objBody);
      if (!response.data.error) {
...
export const deleteLeadByLeadId =
  ...
  async (dispatch) => {
    dispatch(deleteLead());
    try {
      const response = await post("/triarc-sales/lead/deleteLead", objBody, false);
...
export const fetchDealerDetails =
  ...
  async (dispatch) => {
    dispatch(loading(true));
    try {
      const response = await post(`/triarc-sales/master/getDealerList`, objBody);
...
export const fetchDsaDetails = () => async (dispatch) => {
  loading(true);
  try {
    const response = await get(`/triarc-sales/user/getDsaCodeList`);
    // const response = { data: { error: false } };
    if (response.data.error) {
  ...
  async (dispatch) => {
    ...
    try {
      const response = await get(
        `/triarc-sales/lead/getLeadDetails?id=${objBody.id}`
      );
      // const response = { data: { error: false } };
  ...
  async (dispatch) => {
    ...
    try {
      const response = await post(
        "/triarc-sales/coapplicant/addbasicdetails",
        objBody,
        false
      );
      if (response.data.error) {
...
export const getCoapplicantGuarantorByCoapplicantIdService =
  ...
  async (dispatch) => {
    ...
    try {
      const response = await post(
        "/triarc-sales/coapplicant/getcoApplicantDetailsbyApplicantUniqid",
        objBody,
        false
      );
      if (response.data.error) {
...
export const deleteCoapplicantGuarantorService =
  ...
  async (dispatch) => {
    ...
    try {
      const response = await post(
        "/triarc-sales/coapplicant/deleteCoApplicantGurentor",
        objBody,
        false
      );
      if (!response.data.error) {
...
export const createConcentCoapplicantGuarantor =
  ...
  async (dispatch) => {
    ...
    try {
      const response = await post(
        `/triarc-sales/coapplicant/createConsent`,
        objBody
      );
      ts(response.data.message);
...
export const verifyConsentCoapplicantGuarantor =
  ...
  async (dispatch) => {
    ...
    try {
      const response = await post(
        `/triarc-sales/coapplicant/verifyConsent`,
        objBody
      );
      if (!response.data.error) {
...
export const getBranch =
  ...
  async (dispatch) => {
    ...
    try {
      const response = await get(
        `/triarc-sales/master/getBranchlist?employeeId=${objBody.employeeId}`
      );
...
export const getAllLeadsBySearch =
  ...
  async (dispatch) => {
    ...
    try {
      const response = await post(
        `/triarc-sales/lead/getallleadsbysearch`,
        body,
        false
      );
    ...
    export const getGupShupData =
      ...
      async (dispatch) => {
        ...
        try {
          const response = await post(
            `/afx-Gupshup/dashboard/getGupshupData`,
            body,
            false
          );
          if (!response.data.error && !response.error) {
