  ...
  async (dispatch) => {
    ...
    try {
      const response = await post(
        "/triarc-sales/eService/requestEservice",
        objBody,
        false
      );
...
export const getEservice =
  ...
  async (dispatch) => {
    ...
    try {
      const response = await post(
        "/triarc-sales/eService/getEservice",
        objBody,
        false
      );
...
export const uploadLoanAgreement =
  ...
  async (dispatch) => {
    ...
    try {
      const response = await post(
        "/triarc-sales/eService/uploadLoanAgreement",
...
export const deleteUploadedLoanAgreement =
  ...
  async (dispatch) => {
    ...
    try {
      const response = await post(
        "/triarc-sales/eService/deleteLoanAgreement",
        objBody,
        false
      );
      if (!response.data.error) {
...
export const downloadLoanAgreementData =
  ...
  async (dispatch) => {
    ...
    try {
      const response = await post(
        "/triarc-sales/eService/downloadLoanAgreement",
        objBody,
        false
      );
...
export const esignCheck = async (objBody) => {
  try {
    const response = await post(
      `/triarc-sales/eService/saveEsignCheck`,
      objBody,
      false
    ).then((res) => {
      return res.data;
