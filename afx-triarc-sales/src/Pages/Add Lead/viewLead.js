      ...
      <div className="AddLeadContainer p-3">
        ...
        <Row gutter={[30, 15]}>
          ...
          <Col lg={8}>
            ...
            <div>
              {journey === "applicant" ? `${leadDeatils.leadName}` : ""}
            </div>
            <div>
              {journey === "co-applicant" || journey === "guarantor"
                ? `${coapplicantGuarantorDetails.leadName}`
                : ""}
            </div>
          </Col>
          <Col lg={8}>
      ...
      <Modal
        ...
        onOk={(e) =>
          journey === "co-applicant" || journey === "guarantor"
            ...
            : journey === "applicant" && deleteLeads({ id: leadDeatils.id })
        }
        onCancel={(e) => setDeleteFlag(!showDeleteModal)}
        okText="Delete"
        cancelText="Cancel">
        <p>Do you really want to delete the lead?</p>
      </Modal>
    </>
  );
}
