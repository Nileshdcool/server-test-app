      ...
      <Row>
        {props.match.params.disbursement === "pre" && (
          <>
            ...
            <Col lg={12}>
              <Header title={"Shop Act upload"} header={""} />
              <br />
              {formater(disbursalDetails.shopActUpload, false, "shopActUpload")}
            </Col>

            <Col lg={12}>
              <Header title={"Dealer Invoice"} header={""} />
              <br />
              {formater(disbursalDetails.dealerInvoice, false, "dealerInvoice")}
            </Col>

            <Col lg={12}>
              <Header title={"NACH*"} header={""} />
              <br />
              {formater(disbursalDetails.nach, false, "nach")}
            </Col>

            <Col lg={12}>
              <Header title={"Dealer Quotation*"} header={""} />
              <br />
              {formater(
                disbursalDetails.dealerQuotation,
                false,
                "dealerQuotation"
              )}
            </Col>
      ...
      {props.match.params.disbursement === "pre" && (
        <Row justify={"center"}>
          ...
          <Button
            ...
            onClick={saveButton}
            disabled={
              !(disbursalDetails.nach && disbursalDetails.dealerQuotation)
            }
            >
