...
import TvrReference1Edit from './TvrReference1Edit';
import Label from '../../Components/label';
import { getTvrBorrowerReference1 } from '../../Redux/Services/Cases';

const TvrReference1 = (props) => {
            ...
            {_.isEmpty(file) ? (
              ...
              <>
                ...
                <div style={{ display: 'flex' }}>
                  <a
                    target='_blank'
                    href={file?.replace('/var/www/html', BASE)}
                  >
                    {filename}
                  </a>
                  <div style={{ display: 'flex' }}>
